window.onload = function() {
    ...
    const defaultLiffId = "1655385046-0KnKJRwV"; //change the default LIFF value if you are not using a node server
...
function registerButtonHandlers() {
    document.getElementById('openWindowButton').addEventListener('click', function() {
        liff.openWindow({
            url: 'https://catatan-harian-lineliff.herokuapp.com./', // Isi dengan Endpoint URL aplikasi web Kamu
            external: true
        });
    });
